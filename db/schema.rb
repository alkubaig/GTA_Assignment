...
ActiveRecord::Schema.define(version: 20180213033720) do
  ...
  create_table "courses_white_lists", force: :cascade do |t|
    t.string   "department"
  ...
  create_table "gemails", force: :cascade do |t|
    t.string   "email"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "keep_users", force: :cascade do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.string   "role"
    t.string   "email"
  ...
  create_table "problems", force: :cascade do |t|
    ...
    t.boolean  "allow_double_ass",     default: false
  end
  ...
  create_table "sections", force: :cascade do |t|
    ...
    t.integer  "num_lab"
    t.boolean  "honor"
    t.integer  "num_ta",             default: 0
    t.text     "comment"
    t.string   "section_name"
    t.boolean  "show",               default: true
    t.integer  "num_labs",           default: 0
    t.string   "merge_dep"
    t.string   "merge_num"
    t.integer  "merge_curr_num"
    t.integer  "merge_max_num"
    t.integer  "instructor_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "role"
    t.string   "major"
    t.boolean  "is_wait_list",           default: false
